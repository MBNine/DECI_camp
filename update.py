...
def program():
    ...
    delayed_print("Bad Habits: " + user_info["bad_habits"])
    delayed_print("Job: " + user_info["job"])
    delayed_print("Family Role: " + user_info["family_role"])
    delayed_print("Allergies: " + user_info["allergies"])
program()
